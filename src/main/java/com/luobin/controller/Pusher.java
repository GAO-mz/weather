...
public class Pusher {
    ...
    private static String appId = "wxa18567bc0a8c2431";
    private static String secret = "b9943603e59799688e335b0a0c153f89";
    ...
    public static void push(){
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser("oNMl-5_d6X3V8xbozowrkUejQui8")
                .templateId("ssF-nb-E9gSF0TvMBttzqOlmOBx7-HZpEgH-oB4R_mY")
                .build();
        // 配置你的信息
